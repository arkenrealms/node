  ...
  [ItemsMainCategoriesType.OTHER]: [
    ...
    },
    {
      ...
      branches: {
        ...
        [Games.Infinite.id]: {
          attributes: [
            { ...ItemAttributes.IncreaseStat, min: 3, max: 5, description: '{Value}% Cast Speed' },
            { ...ItemAttributes.IncreaseEnergy, min: 6, max: 9, description: '{Value}% Maximum Energy' },
            { ...ItemAttributes.IncreaseStat, min: 5, max: 5, description: '{Value}% Energy Regeneration' },
            ...
            { ...ItemAttributes.CriticalHitChance, min: 3, max: 5 },
            {
              ...
              min: 10,
              max: 10,
              description: '{Value}% Increased Burn Ailment Duration',
            },
    ...
    },
    {
      ...
      branches: {
        ...
        [Games.Infinite.id]: {
          attributes: [
            { ...ItemAttributes.IncreaseDamage, min: 10, max: 25, description: '{Value}% Increased Physical Damage' },
      ...
      branches: {
        ...
        [Games.Infinite.id]: {
          attributes: [
            { ...ItemAttributes.Rarity, min: 3, max: 6, map: ItemRarityNameById },
            { ...ItemAttributes.IncreaseStat, min: 3, max: 5, description: '{Value}% Cast Speed' },
            { ...ItemAttributes.IncreaseEnergy, min: 10, max: 25, description: '{Value}% Maximum Energy' },
            { ...ItemAttributes.IncreaseStat, min: 5, max: 5, description: '{Value}% Energy Regeneration' },
            { ...ItemAttributes.DoublePickupChance, min: 0, max: 1 },
