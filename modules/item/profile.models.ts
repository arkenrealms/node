...
export const ItemTransmuteSchema = mongo.createSchema<Types.ItemTransmuteDocument>(
  'ItemTransmute',
  {
    token: { type: String, maxlength: 500, required: true },
    assetId: { type: mongo.Schema.Types.ObjectId, ref: 'Asset', required: true },
...
export const ItemTransmute = mongo.createModel<Types.ItemTransmuteDocument>('ItemTransmute', ItemTransmuteSchema);
