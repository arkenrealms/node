...
var profileApi = 'https://api.rune.farm';
var cache = {
        ...
        switch (_a.label) {
            case 0:
                ...
                if (cache.getUserAddressByUsername[name])
                    return [2 /*return*/, cache.getUserAddressByUsername[name]];
                return [4 /*yield*/, (0, node_fetch_1.default)("".concat(profileApi, "/users/").concat(name)).catch(function () { })];
            case 1:
                response = _a.sent();
