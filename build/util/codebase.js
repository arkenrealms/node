...
function upgradeCodebase() {
    return __awaiter(this, void 0, void 0, function () {
        var execPromise, e2_1, _a, stdout, stderr;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, execPromise('rm .git/index.lock')];
                case 2:
                    _b.sent();
                    return [3 /*break*/, 4];
                case 3:
                    ...
                    console.log(e2_1);
                    return [3 /*break*/, 4];
                case 4: return [4 /*yield*/, execPromise('git add -A && git stash && git pull', { uid: 1000 })];
                case 5:
