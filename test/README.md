...
## Files
- `socketLink.spec.ts`: client transport routing, callback lifecycle, ID-collision guardrails, timeouts, late response handling, malformed payload permutations, alternate response IDs, and `onAny` support.
