...
## Files
- `socketLink.spec.ts`: client transport routing, callback lifecycle, ID-collision guardrails, timeouts, late response handling, malformed payload permutations, deserialize-failure propagation, immediate same-tick response handling, alternate response IDs, and `onAny` support.
