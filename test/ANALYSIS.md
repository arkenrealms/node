...
- Added server-handler regression for undecodable `params` payloads to ensure status-0 envelope/error propagation instead of unhandled throw behavior.
