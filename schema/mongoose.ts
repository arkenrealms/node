...
export const Account = new Schema<types.Account>(
  {
    metaverseId: {
  ...
  { collection: 'Account', timestamps: { createdAt: 'createdDate', updatedAt: 'updatedDate' } }
);
...
Data.index({ metaverseId: 1, mod: 1, key: 1 }, { unique: true });
...
export const Form = new Schema<types.Form>(
  {
    applicationId: { type: Schema.Types.ObjectId, ref: 'Application', required: true },
    ownerId: { type: Schema.Types.ObjectId, ref: 'Profile', required: true },
    createdById: { type: Schema.Types.ObjectId, ref: 'Profile' },
...
export const FormGroup = new Schema<types.FormGroup>(
  {
    name: String,
    key: String,
    meta: { type: Object, default: {} },
...
export const FormComponent = new Schema<types.FormComponent>(
  {
    name: String,
    key: String,
    meta: { type: Object, default: {} },
...
export const FormSubmission = new Schema<types.FormSubmission>(
  {
    meta: { type: Object, default: {} },
...
export const Character = new Schema<types.Character>(
  {
    ...
    ownerId: { type: Schema.Types.ObjectId, ref: 'Profile', required: true },
    ratingId: { type: Schema.Types.ObjectId, ref: 'Rating' },
    classId: { type: Schema.Types.ObjectId, ref: 'CharacterClass' },
...
export const Npc = new Schema<types.Npc>(
  {
    ...
    meta: { type: Object, default: {} },
    status: { type: String, default: 'Active', enum: ['Paused', 'Pending', 'Active', 'Archived'] },
    characterRaceId: { type: Schema.Types.ObjectId, ref: 'CharacterRace' },
...
export const Omniverse = new Schema<types.Omniverse>(
  {
    ownerId: { type: Schema.Types.ObjectId, ref: 'Profile' },
    ratingId: { type: Schema.Types.ObjectId, ref: 'Rating' },
    key: { type: String, required: true },
...
// export const Organization = new Schema<types.Organization>(
//   {
//     name: { type: String, required: true },
//     description: { type: String },
//     status: { type: String, default: 'Active', enum: ['Paused', 'Pending', 'Active', 'Archived'] },
