...
export const itemData = {
  [ItemsMainCategoriesType.OTHER]: [
    ...
    },
    {
      ...
      recipe: {
        requirement: [{ id: RuneId.ZOD, quantity: 1 }],
      },
      branches: {
        [Games.Raid.id]: {
          ...
          attributes: [
            {
              ...ItemAttributesByName[Games.Raid.id].RandomPerfection1,
              min: 3,
              max: 5,
              value: 5,
              description: 'Access to Rune Royale #{param1}',
            },
    ...
    },
    {
      ...
      hotness: 1,
      attributes: [],
      description: ['Rewarded to Arken Scholars for their noble service.'],
      details: {
        Type: 'Trinket',
        Subtype: 'Codex',
        Distribution: 'Reward',
    ...
    },
    {
      ...
      branches: {
        [Games.Raid.id]: {
          ...
          attributes: [
            {
              ...ItemAttributesByName[Games.Raid.id].CrafterCertificate,
              min: 1,
              max: 2,
              map: CraftingCompetitionWinner,
            },
          ],
        },
        [Games.Evolution.id]: {
    ...
    },
    {
      ...
      branches: {
        [Games.Raid.id]: {
          ...
          presets: {
            [ItemRarity.Magical.id]: [6, 70, 2, 4, 5, 5, 14, 2],
            [ItemRarity.Rare.id]: [5, 80, 3, 4, 6, 6, 16, 3],
            [ItemRarity.Epic.id]: [4, 90, 4, 4, 7, 7, 18, 4],
            [ItemRarity.Mythic.id]: [3, 100, 5, 4, 8, 8, 20, 5],
            [ItemRarity.Unique.id]: [3, 100, 5, 4, 8, 8, 20, 5],
          },
        },
        2: {
          attributes: [
    ...
    },
    {
      ...
      branches: {
        [Games.Raid.id]: {
          ...
          presets: {
            [ItemRarity.Magical.id]: [6, 2, 5, 2, 1, 20],
            [ItemRarity.Rare.id]: [5, 3, 5, 3, 1, 20],
            [ItemRarity.Epic.id]: [4, 4, 5, 4, 1, 20],
            [ItemRarity.Mythic.id]: [3, 5, 5, 5, 1, 20],
            [ItemRarity.Unique.id]: [3, 5, 5, 5, 1, 20],
          },
        },
        [Games.Evolution.id]: {
          attributes: [
        ...
        [Games.Infinite.id]: {
          attributes: [
            { ...ItemAttributesByName[Games.Raid.id].Rarity, min: 3, max: 6, map: ItemRarityNameById },
            {
              ...ItemAttributesByName[Games.Raid.id].IncreaseStat,
              min: 3,
              max: 5,
              description: '{param1}% Increased Cast Speed',
            },
            {
              ...ItemAttributesByName[Games.Raid.id].IncreaseEnergy,
              min: 10,
              max: 25,
              description: '{param1}% Maximum Energy',
            },
            {
              ...ItemAttributesByName[Games.Raid.id].IncreaseStat,
              min: 5,
              max: 5,
              description: '{param1}% Energy Regeneration',
            },
    ...
    //   },
    {
      ...
      branches: {
        [Games.Raid.id]: {
          ...
          presets: {
            [ItemRarity.Magical.id]: [6, 4, 5, 5, 1, SkillIdByName['Mystic Insight']],
            [ItemRarity.Rare.id]: [5, 6, 10, 10, 2, SkillIdByName['Mystic Insight']],
            [ItemRarity.Epic.id]: [4, 8, 15, 15, 3, SkillIdByName['Mystic Insight']],
            [ItemRarity.Mythic.id]: [3, 10, 20, 20, 4, SkillIdByName['Mystic Insight']],
            [ItemRarity.Unique.id]: [3, 10, 20, 20, 4, SkillIdByName['Mystic Insight']],
          },
        },
